  ...
  return (
    <div className="mobile-container">
      ...
      <div className="flex-1 px-4 py-6 space-y-4 pb-nav">
        ...
        {success && <div className="alert-success flex items-center gap-2"><CheckCircle className="w-4 h-4" />{success}</div>}
        ...
        <div className="card overflow-hidden p-0">
          ...
          <div className="divide-y divide-gray-100">
            {[
              { icon: <User className="w-4 h-4 text-[#1a237e]" />, label: 'Nombre', value: user?.first_name },
              { icon: <Mail className="w-4 h-4 text-[#1a237e]" />, label: 'Correo', value: user?.email },
              { icon: <Home className="w-4 h-4 text-[#1a237e]" />, label: 'N° Suministro', value: `SUM-${String(user?.id).padStart(3, '0')}` },
        ...
        <button onClick={logout} className="w-full bg-white border border-red-200 text-red-500 font-semibold py-3 rounded-xl flex items-center justify-center gap-2 hover:bg-red-50 transition">
